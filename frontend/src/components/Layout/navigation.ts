...
export const NAV_ITEMS: NavigationItem[] = [
  ...
  { to: '/investigation', icon: Search, label: 'Investigation', minRole: 'viewer', group: 'Analyze' },
  { to: '/data-quality', icon: Fingerprint, label: 'Data Quality', minRole: 'viewer', group: 'Analyze' },
  ...
  { to: '/ai-chat', icon: MessageSquare, label: 'AI Assistant', minRole: 'viewer', group: 'Analyze' },
  { to: '/ai-insights', icon: Brain, label: 'AI Insights', minRole: 'analyst', group: 'Analyze' },
